(function () {
    window.initCentralChatbot = function (config) {
        ...
        // 1. TẠO STYLE GIAO DIỆN CŨ CỦA BẠN
        ...
        let baseUrl = "https://chatbot-central-api.onrender.com/api/v1/chatbot/query";
        ...
        const API_URL = `${baseUrl}/api/v1/chatbot/query`;
